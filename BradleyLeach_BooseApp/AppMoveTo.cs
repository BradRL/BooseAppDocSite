...
{
    /// <summary>
    /// Command class to move the current drawing position to a specified position.
    /// </summary>
    public class AppMoveTo : CommandTwoParameters, ICommand
    {
        ...
        /// <summary>
        /// Validates that parameters are integers and within valid range (>= 0), then calls the moveTo method.
        /// </summary>
